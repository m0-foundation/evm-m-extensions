...
coverage:
	FOUNDRY_PROFILE=$(profile) forge coverage --force --no-match-path 'test/integration/**/*.sol' --report lcov && lcov --extract lcov.info -o lcov.info 'src/*' --ignore-errors inconsistent && genhtml lcov.info -o coverage
