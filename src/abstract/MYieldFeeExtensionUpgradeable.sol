...
import { MExtensionUpgradeable } from "./MExtensionUpgradeable.sol";

abstract contract MYieldFeeExtensionUpgradeableStorageLayout {
...
/**
 * @title MYieldFeeExtensionUpgradeable
 ...
 * @author M0 Labs
 */
abstract contract MYieldFeeExtensionUpgradeable is
    IContinuousIndexing,
    IMYieldFeeExtension,
    AccessControlUpgradeable,
    MYieldFeeExtensionUpgradeableStorageLayout,
    MExtensionUpgradeable
{
     ...
     */
    function __MYieldFeeExtensionUpgradeable_init(
        string memory name,
