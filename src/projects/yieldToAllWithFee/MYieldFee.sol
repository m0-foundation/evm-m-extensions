...
contract MYieldFee is IContinuousIndexing, IMYieldFee, AccessControlUpgradeable, MYieldFeeStorageLayout, MExtension {
    ...
    /**
     * @notice List of params to initialize the generic M Yield Fee extension token.
    ...
    /**
     * @dev   Initializes the generic M Yield Fee extension token.
     * @param name                  The name of the token (e.g. "M Yield Fee").
     * @param symbol                The symbol of the token (e.g. "MYF").
     * @param mToken                The address of an M Token.
     * @param swapFacility          The address of the Swap Facility.
    ...
    /**
     * @dev   Helper function to initialize the MYieldFee contract via a struct and avoid stack too deep errors.
     * @param initParams The parameters to initialize the M Yield Fee token.
     */
    function __MYieldFee_initViaStruct(MYieldFeeInitParams memory initParams) internal onlyInitializing {
        __MYieldFee_init(
            initParams.name,
            initParams.symbol,
            initParams.mToken,
            initParams.swapFacility,
            initParams.feeRate,
            initParams.feeRecipient,
            initParams.admin,
            initParams.feeManager,
            initParams.claimRecipientManager,
            initParams.upgrader
        );
    }
