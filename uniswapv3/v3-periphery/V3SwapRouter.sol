...
import "uniswapv3/v3-core/libraries/SafeCast.sol";
...
import "uniswapv3/v3-periphery/interfaces/IV3SwapRouter.sol";
import "uniswapv3/v3-periphery/base/PeripheryPaymentsWithFee.sol";
import "uniswapv3/v3-periphery/base/OracleSlippage.sol";
import "./libraries/Constants.sol";
import { PeripheryPaymentsWithFeeExtended } from "uniswapv3/v3-periphery/base/PeripheryPaymentsWithFeeExtended.sol";
...
abstract contract V3SwapRouter is IV3SwapRouter, PeripheryPaymentsWithFeeExtended, OracleSlippage {
    ...
    function exactInputInternal(
        ...
        console.log("fee", fee);
        console.log("pool", address(getPool(tokenIn, tokenOut, fee)));
