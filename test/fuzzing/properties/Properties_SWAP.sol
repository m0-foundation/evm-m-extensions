...
contract Properties_SWAP is Properties_ERR {
    function invariant_SWAP_01(SwapParams memory params) internal returns (bool) {
        if (params.swapType == uint8(SwapType.YTO_TO_YTO)) {
            ...
            fl.eq(yieldExtA, yieldExtAAfter, SWAP_01_00);
            fl.eq(yieldExtB, yieldExtBAfter, SWAP_01_00);
            ...
            fl.eq(yieldExtA, yieldExtAAfter, SWAP_01_01);
            fl.eq(yieldExtB, yieldExtBAfter, SWAP_01_01);
            ...
            fl.eq(yieldExtA, yieldExtAAfter, SWAP_01_02);
            fl.eq(yieldExtB, yieldExtBAfter, SWAP_01_02);
        }
    }
